...
const updateOrCreateRecord = (domain, dnslink) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: recordUpdateData } = yield cfClient.patch(`/${hostname.id}`, {
            dnslink,
        });
...
const publish = () => __awaiter(this, void 0, void 0, function* () {
    ...
    yield updateOrCreateRecord(domain, `/ipfs/${hash}/`);
    console.log("done");
    process.exit(0);
});
publish();
